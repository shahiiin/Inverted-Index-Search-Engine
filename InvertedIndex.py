...
if __name__ == '__main__':
    ...
    inverted = {}
    s = input('plz input number of documents: ')
    documents = {}
    ...
    # listed_documents = []        
    # for k in documents.iterkeys():
    #     listed_documents.append(k)
    # avg_l = return_average_of_documents_lengths(listed_documents)
    ...
    n = raw_input("plz input your query : ")
    queries = n.split(' ')
    ...
    for query in queries:
        ...
        print 'searched for ','"',query,'"',' The result is: ',result

    final = final_search_result(list_for_final_result)
    if (len(final) > 1):
        print 'final documents are: ',final[1]
    else:
        print 'sry no document !'    

        # dict_for_ranking = {}
        # for i in range(len(result)):
        #     for document in result[i][0]:
        #         score = rank(query,document,inverted,avg_l,s)
        #         dict_for_ranking[query] = score

        # print 'dictionary for ranking: ',dict_for_ranking
